 ...
 */
function wye_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['wye_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('wye sample setting'),
  '#default_value' => theme_get_setting('wye_example'),
